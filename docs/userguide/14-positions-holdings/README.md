...
Tradeboard does not currently expose a public REST endpoint for product conversion. Use your broker terminal when the broker supports conversion, and follow its current margin and cut-off rules.
