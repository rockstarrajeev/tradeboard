...
docker pull rockstarrajeev/tradeboard:latest
...
The CI/CD pipeline will automatically build the updated Docker image when you push to the `main` branch. The image will be pushed to Docker Hub as `rockstarrajeev/tradeboard:latest`.
