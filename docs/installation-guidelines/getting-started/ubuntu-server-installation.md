...
wget https://raw.githubusercontent.com/rockstarrajeev/tradeboard/main/install/install.sh
chmod +x install.sh
```
...
```bash
wget https://raw.githubusercontent.com/rockstarrajeev/tradeboard/main/install/install-multi.sh
...
```bash
cd ~/tradeboard-install
wget https://raw.githubusercontent.com/rockstarrajeev/tradeboard/main/install/update.sh
chmod +x update.sh
sudo ./update.sh
```
...
```bash
cd ~/tradeboard-install
wget https://raw.githubusercontent.com/rockstarrajeev/tradeboard/main/install/change-domain.sh
...
* GitHub: [github.com/rockstarrajeev/tradeboard](https://github.com/rockstarrajeev/tradeboard)
* Documentation: [docs.rajeevupadhyay.com](https://docs.rajeevupadhyay.com)
* Discord: [rajeevupadhyay.com/discord](https://www.rajeevupadhyay.com/discord)
...
```
GET https://docs.rajeevupadhyay.com/installation-guidelines/getting-started/ubuntu-server-installation.md?ask=<question>
```
