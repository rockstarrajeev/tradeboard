...
API docs: <https://docs.rajeevupadhyay.com/api-documentation/v1/orders-api/placegttorder>
...
```
GET https://docs.rajeevupadhyay.com/change-log/release/version-2.0.0.8-released.md?ask=<question>
```
