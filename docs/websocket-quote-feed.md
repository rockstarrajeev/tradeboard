...
Tradeboard provides a unified WebSocket server (port 8765 by default) that normalizes market data from the active broker plugin. Clients can subscribe to LTP, Quote, or Depth modes.
