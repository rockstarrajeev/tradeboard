...
# Tradeboard canonical statuses used by other brokers (e.g. Zerodha):
...
def normalize_order_status(status):
    """
    Normalize an Indmoney order status to an Tradeboard canonical status.
...
def calculate_order_statistics(order_data):
    ...
    try:
        ...
        for order in order_data:
            ...
            # Normalize status to Tradeboard canonical value and count it
