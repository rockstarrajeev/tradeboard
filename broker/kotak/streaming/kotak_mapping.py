...
KOTAK_TO_TRADEBOARD_EXCHANGE = {v: k for k, v in OPENALGO_TO_KOTAK_EXCHANGE.items()}
...
KOTAK_TO_TRADEBOARD_PRODUCT = {v: k for k, v in OPENALGO_TO_KOTAK_PRODUCT.items()}
...
KOTAK_TO_TRADEBOARD_ORDER_TYPE = {v: k for k, v in OPENALGO_TO_KOTAK_ORDER_TYPE.items()}
...
def get_kotak_exchange(tradeboard_exchange: str) -> str:
    ...
    """
    return OPENALGO_TO_KOTAK_EXCHANGE.get(tradeboard_exchange, tradeboard_exchange)
...
def get_kotak_product(tradeboard_product: str) -> str:
    ...
    """
    return OPENALGO_TO_KOTAK_PRODUCT.get(tradeboard_product, tradeboard_product)
...
def get_kotak_order_type(tradeboard_order_type: str) -> str:
    ...
    """
    return OPENALGO_TO_KOTAK_ORDER_TYPE.get(tradeboard_order_type, tradeboard_order_type)
