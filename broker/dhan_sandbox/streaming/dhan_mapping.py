...
DHAN_TO_TRADEBOARD_EXCHANGE = {v: k for k, v in OPENALGO_TO_DHAN_EXCHANGE.items()}
...
def get_dhan_exchange(tradeboard_exchange: str) -> str:
    ...
    """
    return OPENALGO_TO_DHAN_EXCHANGE.get(tradeboard_exchange, tradeboard_exchange)
