...
def _normalize_data_exchange(exchange):
    """Map Tradeboard index pseudo-exchanges to their parent cash exchange for data."""
...
class BrokerData:
    def __init__(self, auth_token):
        ...
        # Tradeboard interval -> TradeSmart TPSeries interval (minutes). 'D' -> EOD.
        self.timeframe_map = {
            "1m": "1",
            "3m": "3",
            "5m": "5",
    ...
    def _quote_dict(self, response):
        """Build the Tradeboard quote dict from a GetQuotes response."""
        return {
