    ...
    <div className="container mx-auto py-6 space-y-6 max-w-4xl">
      ...
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Self-host automated trading strategies inside Tradeboard. Each strategy runs as an isolated
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  ...
                  page and copy your Tradeboard API key
                </p>
              </div>
            </div>
            <div className="flex gap-4">
        ...
        <CardContent>
          <Accordion type="single" collapsible className="w-full">
            ...
            <AccordionItem value="resource-limits">
              ...
              <AccordionContent className="text-muted-foreground space-y-3">
                <p>
                  ...
                  Tradeboard. On Windows, these are not enforced at the OS level.
                </p>
                <div className="overflow-x-auto">
                  <table className="w-full text-sm border-collapse">
                    <thead>
            ...
            <AccordionItem value="restart">
              <AccordionTrigger>What happens if I restart Tradeboard?</AccordionTrigger>
              <AccordionContent className="text-muted-foreground space-y-3">
            ...
            <AccordionItem value="add-libraries">
              ...
              <AccordionContent className="text-muted-foreground space-y-3">
                <p>
                  If your strategy needs additional Python libraries, install them in Tradeboard's
                  environment.
                </p>
