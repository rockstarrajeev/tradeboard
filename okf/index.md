...
# Tradeboard Knowledge Bundle

An Open Knowledge Format (OKF) bundle for **Tradeboard**, the self-hosted
...
* [sdk](sdk/index.md) - The Tradeboard Python SDK plus symbol-format, order-constant, lot-size, and websocket format references.
...
* [skills](skills/index.md) - Agentic skill packages that teach AI coding agents to drive Tradeboard (execution, indicators, backtesting).
* [installation](installation/index.md) - Operational guides: upgrade, SMTP email, TOTP, and password recovery.

# Concepts

* [overview](overview.md) - What Tradeboard is, its product surfaces, and how the API is authenticated.
* [responsibilities](responsibilities.md) - The responsibilities every Tradeboard user accepts (transparency, compliance, security, risk ownership).
