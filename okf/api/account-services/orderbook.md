...
resource: https://github.com/rockstarrajeev/tradeboard/blob/main/docs/api/account-services/orderbook.md
tags:
- orders
- account
- orderbook
...
**Source:** [docs/api/account-services/orderbook.md](../../../docs/api/account-services/orderbook.md)
