...
resource: https://github.com/rockstarrajeev/tradeboard/blob/main/docs/api/order-management/splitorder.md
tags:
- order
- split
- execution
...
**Source:** [docs/api/order-management/splitorder.md](../../../docs/api/order-management/splitorder.md)
