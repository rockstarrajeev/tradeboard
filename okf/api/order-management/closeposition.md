...
resource: https://github.com/rockstarrajeev/tradeboard/blob/main/docs/api/order-management/closeposition.md
tags:
- position
- close
- square-off
...
**Source:** [docs/api/order-management/closeposition.md](../../../docs/api/order-management/closeposition.md)
