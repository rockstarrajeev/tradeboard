...
resource: https://github.com/rockstarrajeev/tradeboard/blob/main/docs/api/market-data/multiquotes.md
tags:
- market-data
- quotes
- batch
...
**Source:** [docs/api/market-data/multiquotes.md](../../../docs/api/market-data/multiquotes.md)
