...
resource: https://github.com/rockstarrajeev/tradeboard/blob/main/docs/api/market-data/history.md
tags:
- market-data
- history
- ohlcv
...
**Source:** [docs/api/market-data/history.md](../../../docs/api/market-data/history.md)
