...
# Or using curl
curl -O https://raw.githubusercontent.com/rockstarrajeev/tradeboard/main/install/install.sh
...
- Check the [GitHub repository](https://github.com/rockstarrajeev/tradeboard)
